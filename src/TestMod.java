...
public class TestMod extends Mod {
    ...
    void showEnhancedBrowser() {
        ...
        mainDialog.cont.add(main).size(900f, 750f);
        mainDialog.show();
            ...
            json -> {
                try {
                    ...
                    if(downloadUrl != null) {
                        ...
                        Core.app.post(() -> {
                            Vars.ui.showInfo("Downloading from release...");
    ...
    void downloadFromZipball(ModInfo mod) {
        ...
        Vars.ui.showInfo("Downloading from repository...");
    ...
    void downloadModFile(ModInfo mod, String url) {
        try {
            ...
            Http.get(url)
                ...
                .submit(res -> {
                    try {
                        ...
                        Core.app.post(() -> {
                            installDownloadedMod(mod, file);
                        });
                    } catch(Exception e) {
                        Log.err("Write error", e);
                        Core.app.post(() -> {
                            Vars.ui.showErrorMessage("Save failed: " + e.getMessage());
            ...
            Vars.ui.showErrorMessage("Download error: " + e.getMessage());
