...
public class TestMod extends Mod {
    ...
    void buildModRow(Table table, ModInfo mod) {
        ...
        table.table(Tex.button, row -> {
            ...
            if (installed != null && installed.iconTexture != null) {
                row.image(new TextureRegionDrawable(new TextureRegion(installed.iconTexture))).size(64f).padLeft(10f).padRight(12f);
            } else {
    ...
    void installMod(ModInfo mod) {
        ...
        if (installed != null && installed.iconTexture != null) {
            content.image(new TextureRegionDrawable(new TextureRegion(installed.iconTexture))).size(80f).pad(10f).row();
        } else {
